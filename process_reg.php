...
$db = "SELECT * FROM reg_portal WHERE id='1'";
$qu = mysql_query($db);
...
$select = "SELECT * FROM register WHERE Username = '$mat'";
$em = "SELECT * FROM register WHERE email = '$email'";
$mob = "SELECT * FROM register WHERE mobile = '$mobile'";
$moob = mysql_query($mob);
$mob_num = mysql_num_rows($moob);
$lm = mysql_query($em);
$e_num = mysql_num_rows($lm);
$query = mysql_query($tab);
$let = mysql_query($select);
$num = mysql_num_rows($let);
if(!$query){

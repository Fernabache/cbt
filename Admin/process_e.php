...
header("location:question_post_e.php?msg=$msg&token=$tk");
exit;
}
$sqlcommand = "INSERT INTO questions (paper_type ,categories , exam_type ,question  ,examiner , lecturer,ip_address , OS , browser ,date_time , token) VALUES('$qtype', '$cat' , '$cattype' , '$post' ,'$exam' , '$cato' ,'$ip' ,'$os' ,'$browser' , now() ,'$token')";

...
$fmc="SELECT * FROM multiple_choice WHERE user ='$login' OR user='$user'";
	$fms = mysql_query($fmc);
...
$sql = mysql_query("SELECT * FROM questions WHERE categories='$courses' AND approval_status='approved' ORDER BY $chty $arrt");
...
$sql2 = mysql_query("SELECT * FROM questions WHERE categories='$courses' AND approval_status='approved' ORDER BY $chty $arrt $limit"); 
...
$sql = mysql_query("SELECT * FROM questions WHERE approval_status='approved' ORDER BY $chty $arrt");
//////////////////////////////////// wolexzo07's Pagination Logic ////////////////////////////////////////////////////////////////////////
$nr = mysql_num_rows($sql); // Get total of Num rows from the database query
...
// $sql2 is what we will use to fuel our while loop statement below
$sql2 = mysql_query("SELECT * FROM questions WHERE  approval_status='approved' ORDER BY $chty $arrt $limit"); 
//////////////////////////////// END wolexzo07's Pagination Logic ////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////// wolexzo07's Pagination Display Setup /////////////////////////////////////////////////////////////////////
$paginationDisplay = ""; // Initialize the pagination output variable
// This code runs only if the last page variable is ot equal to 1, if it is only 1 page we require no paginated links to display

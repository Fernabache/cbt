<p style="padding:10px;text-align:center;color:green;letter-spacing:2px;"><?php require("upload_ans.php");?></p>
<p style="padding:10px;text-align:center;color:green;letter-spacing:2px;"><?php require("delete_file.php");?></p>
<div class='que'>
